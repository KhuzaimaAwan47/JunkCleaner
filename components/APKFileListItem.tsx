...
type APKFileListItemProps = {
  item: APKFileInfo;
  selected: boolean;
  onPress: () => void;
};

const APKFileListItem: React.FC<APKFileListItemProps> = ({
  item,
  selected,
  onPress,
}) => {
        ...
        <View style={styles.itemInner}>
          ...
          <View style={styles.infoColumn}>
            ...
            <View style={styles.badgeRow}>
              <Text style={styles.tag}>APK</Text>
              {item.modifiedDate ? (
                <Text style={styles.metaText}>{formatTimestamp(item.modifiedDate / 1000)}</Text>
              ) : null}
              {item.ageDays > 0 && (
...
export default APKFileListItem;
